...
This model is based on the NetLogo model "Packet on Network".
...
[Stonedahl, F. and Wilensky, U. (2008). NetLogo Packet on a Network model](http://ccl.northwestern.edu/netlogo/models/VirusonaNetwork). 
