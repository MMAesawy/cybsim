...
model_params = {
    ...
    "random_seed": UserSettableParameter(param_type='number', name='Global seed\'s value', value=1987,
                                               description='Set the value of the global seed'),
    'num_firms': UserSettableParameter(param_type='slider', name='Number of subnetworks', value=12, min_value=4, max_value=50, step=1,
                                                  description='Choose how many subnetworks to have'),
    'num_attackers_initial': UserSettableParameter(param_type='slider', name='Initial number of attackers', value=5, min_value=1, max_value=10, step=1,
                                                  description='Choose how many attackers to have initially'),
    'num_attackers_total': UserSettableParameter(param_type='slider', name='Total number of attackers', value=10, min_value=10, max_value=20, step=1,
                                                  description='Choose how many total attackers to have'),
    ...
    'reciprocity': UserSettableParameter(param_type='slider',name='Reciprocity',value=2, max_value=5,min_value=1, step=0.5,
                                         description='Parameter representing how much firms move closer or further from each other'),
    'trust_factor': UserSettableParameter(param_type='slider',name='Trust Factor',value=2, max_value=5,min_value=1, step=0.5,
                                         description='Parameter representing how much firms trust each other less/more after interacting'),
    'initial_trust': UserSettableParameter(param_type='slider', name='Initial trust', value=0.5, max_value=1, min_value=0,
                                          step=0.1,description='Parameter representing how much firms are initially trusting of each other to share information'),
    'initial_closeness': UserSettableParameter(param_type='slider', name='Initial closeness', value=0.2, max_value=1, min_value=0,
                                          step=0.1,description='Parameter representing how much firms are initially close with each other representing their likelihood to interact'),
    'security_update_interval': UserSettableParameter(param_type='slider', name='Security Update Interval', value=7, max_value=50, min_value=1,
                                          step=1,description='Parameter representing interval at which firms update their security'),
    # 'org_memory': UserSettableParameter(param_type='slider', name='Firm Memory', value=3, max_value=20, min_value=1,
...
#                                 element_names=["Compromised Devices", "Firm Closeness", " Average Trust"],
#                                 width=1000)
...
server = ModularServer(CybCim, [card_view], 'Computer Network', model_params)
